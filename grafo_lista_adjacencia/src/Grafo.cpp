...
/** TODO (jhcedro#1#17-12-2016): So funciona para grafo direcionado */
...
bool Grafo::ehConexo(){
    /** TODO (jhcedro#1#17-12-2016): Implementar pois eh usada no menu
    usar numeroComponentesConexas ou ehKConexo?? */
